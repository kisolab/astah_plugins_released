...
def FindPackagePath(packageName, knownFileName, searchPaths):
    """Find a package.
       ...
       Given a ni style package name, confirm the package is registered.
...
def RegisterShellInfo(searchPaths):
    ...
    FindRegisterHelpFile("Python.hlp", searchPaths, "JythonDemo Python Documentation")
    FindRegisterHelpFile("ActivePython.chm", searchPaths, "JythonDemo Python Documentation")
...
See also the "regcheck.py" utility which will confirm and dump the contents
of the registry.
"""
