...
class Transport(threading.Thread, ClosingContextManager):
    ...
    def __init__(
        ...
        self.setDaemon(True)
        self.sock = sock
        # we set the timeout so we can confirm self.active periodically to
    ...
    def connect(
        ...
        # confirm host key if we were given one
        # If GSS-API Key Exchange was performed, we are not required to confirm
        # the host key.
