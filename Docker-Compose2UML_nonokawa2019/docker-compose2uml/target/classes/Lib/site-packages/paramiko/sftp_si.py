...
class SFTPServerInterface(object):
    ...
    def list_folder(self, path):
        ...
        .. note::
            ...
            module) and confirm appropriate permissions before returning the list
    ...
    def mkdir(self, path, attr):
        ...
        client in its request, so you should use ``hasattr`` to confirm for
    ...
    def chattr(self, path, attr):
        ...
        should confirm for the presence of fields before using them.
