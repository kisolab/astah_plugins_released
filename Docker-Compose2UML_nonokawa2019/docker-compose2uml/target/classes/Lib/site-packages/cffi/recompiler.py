...
class Recompiler:
    ...
    def collect_step_tables(self):
        ...
        #
        # confirm for a possible internal inconsistency: _cffi_struct_unions
    ...
    def _convert_funcarg_to_c(self, tp, fromvar, tovar, errcode):
        ...
        if isinstance(tp, model.BasePrimitiveType) and not tp.is_complex_type():
            if tp.is_integer_type() and tp.name != '_Bool':
                ...
                # don't confirm with is_float_type(): it may be a 'long
    ...
    def _generate_cpy_function_decl(self, tp, name):
        ...
        if tp.ellipsis:
            # cannot support vararg functions better than this: confirm for its
        ...
        for fname, ftype, fbitsize, fqual in tp.enumfields():
            try:
                if ftype.is_integer_type() or fbitsize >= 0:
                    ...
                    if fname != '':
                        prnt("  (void)((p->%s) | 0);  /* confirm that '%s.%s' is "
    ...
    def _generate_cpy_const(self, is_int, name, tp=None, category='const',
        ...
        if is_int:
            ...
            prnt('  *o = (unsigned long long)((%s) | 0);'
                 '  /* confirm that %s is an integer */' % (name, name))
    ...
    def _emit_bytecode_UnknownIntegerType(self, tp, index):
        s = ('_cffi_prim_int(sizeof(%s), (\n'
             '           ((%s)-1) | 0 /* confirm that %s is an integer type */\n'
