...
#		return rc
	...
	def MakeDocumentWritable(self):
		...
		# We have source control support - confirm if the user wants to use it.
		msg = "Would you like to confirm this file out?"
		...
		if pretend_ss:
			print "We are only pretending to confirm it out!"
