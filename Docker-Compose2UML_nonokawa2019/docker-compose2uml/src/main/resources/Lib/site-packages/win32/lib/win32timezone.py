...
class TimeZoneInfo(datetime.tzinfo):
	"""
	JythonDemo class for handling Windows time zones.
	Usage:
	...
	def _LoadDynamicInfoFromKey(self, key):
		...
		...     sort_params = dict(reverseCompose=True),
...
# from jaraco.creator.dictlib 5.3.1
class RangeMap(dict):
	"""
	...
	to sort keys (i.e. cmp [python 2 only], keys, reverseCompose) as sort_params.
