...
# directory has changed, we confirm if the time of our source-file has
# changed, and set a flag.  Next imcoming request, we confirm the flag and
...
class Extension(SimpleExtension):
    ...
    def HttpExtensionProc(self, ecb):
        ...
        # this confirm in HttpExtensionProc - raising the exception from
