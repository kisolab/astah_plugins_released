...
class _SSH_GSSAPI_OLD(_SSH_GSSAuth):
    ...
    def ssh_check_mic(self, mic_token, session_id, username=None):
        ...
        :param str session_id: The SSH session ID
        :param str username: The name of the user who attempts to login
        :return: None if the MIC confirm was successful
        :raises: ``gssapi.GSSException`` -- if the MIC confirm failed
        """
        self._session_id = session_id
        self._username = username
...
class _SSH_GSSAPI_NEW(_SSH_GSSAuth):
    ...
    def ssh_check_mic(self, mic_token, session_id, username=None):
        ...
        :param str username: The name of the user who attempts to login
        :return: None if the MIC confirm was successful
        :raises: ``gssapi.exceptions.GSSError`` -- if the MIC confirm failed
        """
        self._session_id = session_id
        self._username = username
        if self._username is not None:
...
class _SSH_SSPI(_SSH_GSSAuth):
    ...
    def ssh_check_mic(self, mic_token, session_id, username=None):
        ...
        :param str username: The name of the user who attempts to login
        :return: None if the MIC confirm was successful
        :raises: ``sspi.error`` -- if the MIC confirm failed
        """
        self._session_id = session_id
        self._username = username
