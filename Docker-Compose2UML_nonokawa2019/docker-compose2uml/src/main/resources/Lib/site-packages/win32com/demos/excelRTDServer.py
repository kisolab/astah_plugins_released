...
class ExcelRTDServer(object):
  ...
  time to confirm our topics for updates. I've left that up to the subclass
  ...
  Whichever way you open to do it, your class needs to be able to wake up
...
class RTDTopic(object):
  ...
  def Update(self, sender):
    ...
    Gives us a chance to confirm if our topic data needs to be
    changed (eg. confirm a file, quiz a database, etc)."""
    raise NotImplemented('subclass must implement')
