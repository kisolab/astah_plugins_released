...
public class CodeGenerator {
  ...
  public static void generate() throws GenerationException {
    try {
      ...
      umlc.umlcheckaction();
      JOptionPane.showMessageDialog(null, "UMLcheck fin");
      System.out.println("UMLcheck fin");
      ...
      if (_not) {
        try {
          ...
          JOptionPane.showMessageDialog(null,_t);
      ...
      for (final IClass iClass : _classes) {
        {
          ...
          System.out.println("CodeGenerator " + iClass);
          utils.setStatemachine(utils.getStatemachines().get(iClass));
          utils.setActivity(utils.getActivities().get(iClass)); //--
          utils.setmap();
          map.put("u", utils);
